...
export function PerfilAdmin({
  ...
  const [profile, setProfile] = useState<AdminProfileData>({
    ...
    jobTitle: 'Administrador de la Clínica',
    systemRole: 'Administrador General',
  ...
  return (
    <div className="h-screen max-h-screen overflow-hidden flex flex-col bg-bone relative text-charcoal">
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <main
          key={activeRoute}
          className="flex-1 overflow-y-auto relative p-4 sm:p-6 lg:p-8 animate-view-popup max-w-[1600px] w-full mx-auto"
        >
          <DashboardBackgroundDecoration />
