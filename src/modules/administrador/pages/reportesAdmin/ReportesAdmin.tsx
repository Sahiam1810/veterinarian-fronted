    ...
    <div className="h-screen max-h-screen overflow-hidden flex flex-col bg-bone relative text-charcoal">
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        >
          ...
          {/* Listado Detalle de Citas Recientes (Sección Inferior) */}
          <div className="relative z-10 bg-white border border-border-tan rounded-2xl shadow-[0_4px_20px_rgba(35,78,70,0.04)] overflow-hidden animate-pop-in stagger-4">
            {/* Header de la Tabla */}
