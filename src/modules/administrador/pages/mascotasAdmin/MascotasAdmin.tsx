...
export function MascotasAdmin({
  ...
  return (
    <div
      className="mascotas-admin h-screen max-h-screen overflow-hidden flex flex-col bg-bone relative"
      onClick={closeMenu}
    >
      {/* 1. Header Fijo */}
      <AdminHeader
        ...
        >
          ...
          <div className="relative z-10 border-b border-border-tan/70 flex items-center justify-between gap-4 animate-pop-in stagger-1">
            <div className="flex items-center gap-6 sm:gap-8">
              <button
                ...
                className={`mascotas-admin__tab-btn ${
                  activeTab === 'mascotas' ? 'mascotas-admin__tab-btn--active' : ''
                }`}
              >
                Mascotas
              </button>
              ...
              <button
                ...
                className={`mascotas-admin__tab-btn ${
                  activeTab === 'duenos' ? 'mascotas-admin__tab-btn--active' : ''
                }`}
              >
                Dueños
              </button>
          ...
          {activeTab === 'mascotas' && (
            <div className="space-y-4 sm:space-y-5 relative z-10 animate-view-popup">
              ...
              <div
                className="mascotas-filter-card flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3"
                onClick={(e) => e.stopPropagation()}
              >
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3 flex-1">
                  ...
                  <select
                    ...
                    className="mascotas-select px-3.5 py-2 rounded-xl border border-border-tan bg-white text-xs sm:text-sm text-charcoal font-medium focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition cursor-pointer min-w-[150px]"
                  >
                  ...
                  <select
                    ...
                    className="mascotas-select px-3.5 py-2 rounded-xl border border-border-tan bg-white text-xs sm:text-sm text-charcoal font-medium focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition cursor-pointer min-w-[140px]"
                  >
                ...
                <button
                  ...
                  className="btn-terracotta inline-flex items-center justify-center gap-2 px-4 sm:px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition shadow-xs cursor-pointer shrink-0 active:translate-y-0.5"
                >
              ...
              {/* Tabla de Mascotas */}
              <div className="mascotas-table-card overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="mascotas-table w-full text-left border-collapse min-w-[700px]">
                    <thead>
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    {Array.from({ length: totalMascotaPages }, (_, i) => i + 1).map((num) => (
                      <button
                        ...
                        className={`pagination-btn ${
                          mascotaPage === num ? 'pagination-btn--active' : ''
                        }`}
                      >
                        {num}
                      </button>
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    {Array.from({ length: totalDuenoPages }, (_, i) => i + 1).map((num) => (
                      <button
                        ...
                        className={`pagination-btn ${
                          duenoPage === num ? 'pagination-btn--active' : ''
                        }`}
                      >
                        {num}
                      </button>
