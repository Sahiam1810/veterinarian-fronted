...
export function AgendaAdmin({
  ...
  // Data states
  const [citas, setCitas] = useState<CitaAdmin[]>(INITIAL_CITAS)
  ...
  const [editingCita, setEditingCita] = useState<CitaAdmin | null>(null)
