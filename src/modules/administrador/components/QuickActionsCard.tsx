...
export function QuickActionsCard({
  ...
  return (
    <div className="bg-white/95 backdrop-blur-xs rounded-3xl p-4 sm:p-5 lg:p-6 border border-border-tan shadow-[0_4px_24px_rgba(35,78,70,0.035)] flex flex-col relative overflow-hidden">
      {/* Title */}
      ...
      <div className="flex flex-col gap-2.5 sm:gap-3">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-xs sm:text-sm font-bold text-charcoal group-hover:text-brand transition-colors">
                Crear Usuario
              </span>
              <span className="text-[10px] sm:text-[11px] text-charcoal/70">
                Personal clínico
              </span>
            </div>
          </div>
        ...
        <button
          ...
          className="w-full text-left mt-0.5 bg-gradient-to-r from-brand to-brand-darker hover:from-brand-hover hover:to-brand-darkest text-white rounded-2xl p-3 sm:p-3.5 flex items-center gap-3 transition-all duration-200 cursor-pointer shadow-md hover:shadow-lg hover:shadow-brand/20 group active:translate-y-0.5"
        >
