...
export function VetChangePasswordModal({
  isOpen,
  onClose,
  onSubmit,
  isSubmitting,
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="vet-change-password-title"
    >
      <div className="bg-white rounded-3xl border border-border-tan shadow-[0_8px_32px_rgba(35,78,70,0.16)] w-full max-w-md overflow-hidden flex flex-col">
        ...
        <div className="px-6 py-5 border-b border-border-tan/60 flex items-center justify-between bg-cream/30">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 id="vet-change-password-title" className="text-base font-black text-brand leading-tight">
                Cambiar Contraseña
              </h3>
              <p className="text-xs text-sage font-medium mt-0.5">
                Seguridad de tu cuenta de veterinario
              </p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-4">
          <div className="rounded-xl bg-emerald-50/80 border border-emerald-200/60 p-3 text-xs text-emerald-900 flex items-center justify-between">
            <span>Persistencia en el servidor</span>
            <span className="font-mono text-[10px] bg-emerald-100/70 px-1.5 py-0.5 rounded font-bold">
