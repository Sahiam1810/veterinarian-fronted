...
export function BellPlusIcon({ className = 'w-6 h-6', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path d="M19 2v4" strokeWidth="2" />
      <path d="M17 4h4" strokeWidth="2" />
    </svg>
  )
}

export function UserAvatarIcon({ className = 'w-6 h-6', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path d="M6.2 18.5c1.4-2.1 3.5-3.5 5.8-3.5s4.4 1.4 5.8 3.5" />
    </svg>
  )
}
...
export function CalendarPlusIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function CheckCircleIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="m8.5 12 2.5 2.5 4.5-5" strokeWidth="2" />
    </svg>
  )
}
...
export function StethoscopeIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path d="M3 3h3" />
      <path d="M12 3h3" />
      <path d="M9 12.5v4a3.5 3.5 0 0 0 7 0v-1" />
      <circle cx="16" cy="14" r="2" />
    </svg>
  )
}

export function PawIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function UserPlusIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function PetMedicalIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <line x1="9" y1="3" x2="9" y2="21" strokeDasharray="1 2" strokeWidth="1" />
...
export function DoctorIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function MoreVerticalIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function OwnersIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path d="M22 19a3 3 0 0 0-3-3h-1" />
    </svg>
  )
}

export function AvailabilityIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function MedicalHistoryIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function EyeOffIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
// Icono de impresora
export function PrinterIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function PillIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
// Icono de paquete / insumo / inventario
export function PackageIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
// Iconos de navegación / carrusel / paginación
